...
**
** Created: Wed Sep 24 11:54:31 2008
**      by: The Qt Meta Object Compiler version 59 (Qt 4.4.2)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../src/include/GraphDlg.h"
...
static const uint qt_meta_data_GraphDlg[] = {
...
static const char qt_meta_stringdata_GraphDlg[] = {
    "GraphDlg\0\0,\0updateOutChn(int,int*)\0"
    "updateInChn(int,int*)\0"
};

const QMetaObject GraphDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GraphDlg,
      qt_meta_data_GraphDlg, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GraphDlg))
        return static_cast<void*>(const_cast< GraphDlg*>(this));
